...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
        <div class="p-5 sm:p-6 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <h2 class="text-base sm:text-lg font-semibold text-slate-900">Transaction History</h2>
            <div class="flex items-center gap-2">
                <select class="px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs sm:text-sm text-slate-700 focus:outline-none focus:border-blue-500">
        ...
        <div class="p-8 sm:p-12 md:p-16 text-center">
            ...
            <a href="{{ url('/subscription') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow-sm shadow-blue-500/25 transition">
                View Plans
            </a>
        </div>

        <!-- Sample table (hidden — for reference) -->
        {{-- <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                        <th class="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wide">Date</th>
                        <th class="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wide">Description</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    <tr class="hover:bg-slate-50">
                        <td class="px-5 py-4 text-slate-900">Jan 15, 2025</td>
                        <td class="px-5 py-4 text-slate-900">Pro Plan — Monthly</td>
                        <td class="px-5 py-4 text-slate-900 font-semibold">$9.00</td>
                        <td class="px-5 py-4"><span class="px-2.5 py-1 bg-emerald-100 text-emerald-700 text-xs font-medium rounded-full">Success</span></td>
                        <td class="px-5 py-4 text-right"><a href="#" class="text-blue-600 hover:text-blue-700 text-xs font-medium">Invoice</a></td>
                    </tr>
                </tbody>
            </table>
        </div> --}}
