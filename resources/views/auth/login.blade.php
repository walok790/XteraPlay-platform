    ...
    <div class="w-full max-w-md">
        ...
        <div class="glass-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 glow-border">
            ...
            <div class="text-center mb-6 sm:mb-8">
                ...
                <h1 class="text-xl sm:text-2xl font-bold text-white mb-1">Welcome Back</h1>
                <p class="text-xs sm:text-sm text-dark-400">Sign in to your account to continue</p>
            </div>
            ...
            <form method="POST" action="/login" class="space-y-4 sm:space-y-5">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5 sm:mb-2">
                        <label for="password" class="text-xs sm:text-sm font-medium text-dark-300">Password</label>
                        <a href="#" class="text-[11px] sm:text-xs text-primary-400 hover:text-primary-300 font-medium">Forgot password?</a>
                    </div>
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="remember" id="remember" class="w-4 h-4 rounded border-dark-600 bg-dark-800 text-primary-600 focus:ring-primary-500/25">
                    <label for="remember" class="text-xs sm:text-sm text-dark-400">Remember me</label>
                </div>
            ...
            <p class="text-center text-xs sm:text-sm text-dark-400 mt-5 sm:mt-6">
                ...
                <a href="/register" class="text-primary-400 hover:text-primary-300 font-semibold">Sign Up Free</a>
            </p>
        </div>
    </div>
</section>
